...
- [ ] Удалён тип RecordedStep, плоский массив аннотаций с полем url
...
## Где остановились
Этап 2.5 — UX-улучшения. Добавлена кнопка "Copy JSON" в браузере,
которая через Playwright bridge получает все аннотации со всех страниц и копирует в буфер обмена.
